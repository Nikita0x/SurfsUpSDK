...
# this script is used for typewriter effect:
# letters_per_second -  speed of typing
# pause - how long will it wait until next string
# lines - an array of strings - texts to be typed
